...
export function DOCXViewer({ _url, title, pages }: DOCXViewerProps) {
  ...
  const pageImages: string[] = pages || defaultPages;
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex justify-between items-center bg-purple-50 dark:bg-purple-900/20 p-3 rounded-t-lg">
            ...
            <div className="relative w-full h-full">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-8">
                  <h2 className="text-xl font-bold mb-4">DOCX 미리보기</h2>
      ...
      <div className="bg-purple-50 dark:bg-purple-900/10 p-2 border-t">
        <div className="flex justify-center space-x-2 overflow-x-auto px-2">
          {pageImages.map((page: string, index: number) => (
            <button
              key={index}
