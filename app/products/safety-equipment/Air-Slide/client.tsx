    ...
    return (
        <div className="relative min-h-screen text-white">
            ...
            <div className="fixed inset-0 z-0">
                <Image
                    src={getImagePath('/images/products/Air-Slide/main/visual.jpg')}
                                ...
                                id !== 'hero' && (
                                    ...
                                    >
                                        {id === 'overview' ? (
                                            ...
                                            <>
                                                <ListChecks className="h-3 w-3 mr-1" />기술 사양
                                            </>
                                        ) : id === 'caseStudies' ? (
                                            <>
            ...
            <div className="relative z-10">
                    ...
                    <div className="max-w-7xl w-full mx-auto px-6 md:px-8 lg:px-12 pt-24 flex flex-col items-center justify-center h-full relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-gray-300 mb-2 leading-relaxed">
                                고압 압축 공기로 신속하게 펼쳐지는 혁신적인 피난용 미끄럼틀입니다.
                            </p>
                        </div>
                    </div>
                ...
                {/* 히어로 이후 모든 콘텐츠 섹션을 감싸는 단일 배경 컨테이너 (완강기 페이지와 동일하게 적용) */}
                        ...
                        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
                                ...
                                <div className="flex flex-col h-full">
                                    ...
                                    >
                                        <Image
                                            src={mainImage || "/images/products/Air-Slide/thumbnail.jpg"}
                            ...
                            {/* 인증 및 주의사항은 이미지 아래, 별도 카드로 분리하여 강조 */}
                        ...
                        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-gray-400 max-w-2xl mx-auto text-base lg:text-lg">
                                    에어슬라이드의 상세한 기술 사양 및 재질 정보를 확인하세요.
                                </p>
                            </div>
                                            ...
                                            <div className="mt-6 max-w-md mx-auto text-left">
                                                <table className="w-full text-sm">
                                                    <tbody className="divide-y divide-white/10">
                                                        {[
                                                            { label: "제품길이 (m)", value: "5.0 ~ 10.5 (m)" },
                                                            { label: "적용높이 (m)", value: "3.5 ~ 7.0 (m)" },
                                                            { label: "활강 폭 (mm)", value: "1,200 (mm)" },
                                                            { label: "원단 구성", value: "폴리에스터 + Sol-Tarpaulin 특수코팅" },
                                                            { label: "원단 성능", value: "인장강도 3,000N 이상, 방수, 방염처리" },
                                                            { label: "총 중량", value: "30 ~ 50 kg (설치프레임 제외)" },
                                                        ].map(item => (
                    ...
                    >
                        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            <div className="text-center mb-16">
                                ...
                                <div className="w-24 h-1 mx-auto bg-white/50 rounded-full mb-6 animate-pulse" style={{ animationDuration: '3s' }}></div>
                                <p className="text-gray-400 max-w-2xl mx-auto text-base lg:text-lg">
                                    에어슬라이드의 다양한 건물 및 비상 상황에 설치되어 활용되는 에어슬라이드의 실제 모습을 확인하세요.
                                </p>
                            </div>

                            {/* 실제 적용 사례 이미지/설명 필요 - public/images/products/Air-Slide/gallery/ 경로의 이미지 활용 예시 */}
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                                {[
                                    {
                                        imgSrc: "/images/products/Air-Slide/gallery/m_1_7_1_img.jpg",
                                        title: "고층 빌딩 설치 사례",
                                        description: "도심 고층 빌딩의 비상 탈출로로 설치된 에어슬라이드."
                                    },
                                    {
                                        imgSrc: "/images/products/Air-Slide/gallery/m_1_7_1_img1.jpg",
                                        title: "공공기관 대피 훈련",
                                        description: "공공기관에서의 정기적인 비상 대피 훈련에 사용되는 모습."
                                    },
                                    {
                                        imgSrc: "/images/products/Air-Slide/gallery/m_1_7_1_img2.jpg",
                                        title: "신속한 전개 시연",
                                        description: "위급 상황 시 에어슬라이드의 신속한 전개 및 사용법 시연."
                                    }
                                ].map((item, index) => (
                    ...
                    >
                        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            <div className="text-center mb-16">
                                ...
                                <div className="w-24 h-1 mx-auto bg-white/50 rounded-full mb-6 animate-pulse" style={{ animationDuration: '3s' }}></div>
                                <p className="text-gray-400 max-w-2xl mx-auto text-base lg:text-lg">
                                    에어슬라이드의 다양한 이미지와 작동 영상을 통해 제품을 자세히 살펴보세요.
                                </p>
                ...
                {/* AI 검색 최적화용 JSON-LD 데이터 섹션 (변경 없음) */}
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            // specTable 정보를 JSON-LD에 추가하는 것은 복잡할 수 있으므로, 주요 사양 몇 개만 명시하거나 생략 가능
                            // 예시: "material", "weight", "dimensions" 등 product.ts의 Product 타입에 명시적 필드가 있다면 활용
                        })
                    }}
                />
            </div>
