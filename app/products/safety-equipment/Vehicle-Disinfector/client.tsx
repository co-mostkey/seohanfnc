...
/**
 * 차량소독기 실외형 상세 페이지 컴포넌트
 * 보라색 테마를 적용하고 제품 상세 정보를 표시합니다.
 */
    ...
    return (
        <div className="relative min-h-screen text-white">
            <div className="fixed inset-0 z-0">
                <Image
                    src={getImagePath('/images/products/Vehicle-Disinfector/thumbnail.jpg')}
            ...
            >
                <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div className="p-6 md:p-8">
                                    {documents && documents.length > 0 ? (
                                        ...
                                        <div className="p-8 text-center text-gray-400 border border-dashed border-gray-700 rounded-lg">
                                            <FileTextIcon className="h-12 w-12 mx-auto text-gray-600 mb-4" />
                                            <p>현재 등록된 문서 자료가 없습니다.</p>
                                            <p className="text-sm mt-2">제품 문의를 통해 필요한 자료를 요청하실 수 있습니다.</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        <div>
                            <div className="bg-purple-900/30 backdrop-blur-md border border-purple-500/20 rounded-xl overflow-hidden shadow-2xl h-full">
                                <div className="p-6 md:p-8 border-b border-purple-500/20">
                                    <h3 className="text-xl font-bold text-white font-serif flex items-center" style={{ fontFamily: 'var(--font-playfair)' }}>
                                        <MessageCircle className="h-5 w-5 mr-3 text-purple-300 flex-shrink-0" />
                                        제품 문의하기
                                    </h3>
                                </div>
                                <div className="p-6 md:p-8 text-center">
                                    <div className="mb-6">
                                        <p className="text-gray-300 mb-4">
                                            제품 사양, 가격, 설치, 유지보수 등에 관한 모든 문의를 환영합니다.
                                        </p>
                                        <p className="text-gray-400 text-sm">
                                            전문 담당자가 24시간 이내에 답변해 드립니다.
                                        </p>
                                    </div>
                                    <Link
                                        href={`/support/contact?product_name=${encodeURIComponent(currentProductName)}&product_id=${encodeURIComponent(productId)}`}
                                        className="inline-flex items-center justify-center w-full py-3 px-6 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white font-medium rounded-lg transition-all shadow-lg hover:shadow-purple-700/30"
                                    >
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                    ...
                    {allMediaItems.length > 0 && (
                        <div className="mb-10 flex justify-center">
                            <div className="bg-black/30 backdrop-blur-sm rounded-full p-1 inline-flex">
                                <button
                                    onClick={() => setActiveMediaTab('images')}
                                    className={`px-6 py-2 rounded-full text-sm transition-all ${activeMediaTab === 'images'
                                ...
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-full text-sm transition-all ${activeMediaTab === 'videos'
                                        ? 'bg-purple-700 text-white shadow-md'
                                        : 'text-gray-300 hover:text-white'
                                        }`}
                                >
                    ...
                    {allMediaItems.length > 0 ? (
                        <div className="w-full">
                            <ProductImageGallery items={
                                activeMediaTab === 'images' ? imageItems : videoItems
                            } />
                        </div>
                    ) : (
                        <div className="p-16 text-center text-gray-400 border border-dashed border-gray-700 rounded-lg">
                            <ImageIcon className="h-16 w-16 mx-auto text-gray-600 mb-4" />
                            <p className="text-xl font-medium">갤러리 이미지가 준비중입니다</p>
                            <p className="text-sm mt-2">곧 더 많은 제품 이미지와 영상이 업로드될 예정입니다.</p>
                        </div>
                    )}
                </div>
            </section>
