                    ...
                    <div className="max-w-7xl w-full mx-auto px-6 md:px-8 lg:px-12 pt-24 flex flex-col items-center justify-center h-full relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-lg text-gray-300 mb-2 leading-relaxed">
                                화재시 또는 재난상황 발생시 이동설치가 가능한 구조로 가볍고 신속한 설치가 가능한 구조의 인명구조 장비입니다.
                            </p>
                        </div>
                    </div>
                        ...
                        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-gray-400 max-w-2xl mx-auto text-base lg:text-lg">
                                    수직강하식 구조대의 상세한 기술 사양 및 재질 정보를 확인하세요.
                                </p>
                            </div>
                                            ...
                                            <div className="mt-6 max-w-md mx-auto text-left">
                                                <table className="w-full text-sm">
                                                    <tbody className="divide-y divide-white/10">
                                                        {[
                                                            { label: "보관규격 가로×세로×높이(mm)", value: "880 X 500 X 960" },
                                                            { label: "보관규격 가로×세로×높이(mm)", value: "880 × 450 × 1,300" },
                                                            { label: "활강포 길이 (m)", value: "4.5 ~ 70 m" },
                                                            { label: "활강시간 (sec.)", value: "3 ~ 4 m/sec." },
                                                            { label: "활강간격 (sec.)", value: "4 ~ 5 sec." },
                                                            { label: "관련검사", value: "한국소방산업기술원 제품승인품" },
                                                        ].map(item => (
                    ...
                    >
                        <div className="relative z-10 max-w-6xl mx-auto px-4 md:px-6 lg:px-8 w-full">
                            <div className="text-center mb-16">
                                ...
                                <div className="w-24 h-1 mx-auto bg-white/50 rounded-full mb-6 animate-pulse" style={{ animationDuration: '3s' }}></div>
                                <p className="text-gray-400 max-w-2xl mx-auto text-base lg:text-lg">
                                    다양한 건물 및 비상 상황에서 활용되는 수직강하식 구조대의 실제 모습을 확인하세요.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                                {[
                                    {
                                        imgSrc: "/images/products/Vertical-Rescue-Equipment/gallery/m_1_7_1_img.jpg",
                                        title: "수직강하식 구조대",
                                        description: "수직강하식 구조대 이미지"
                                    },
                                    {
                                        imgSrc: "/images/products/Vertical-Rescue-Equipment/gallery/m_1_7_1_img1.jpg",
                                        title: "수직강하식 구조대 사용예",
                                        description: "수직강하식 구조대 사용예 이미지"
                                    }
                                ].map((item, index) => (
