...
export default function VehicleDisinfectorPage() {
    ...
    if (!product) {
        ...
        return (
            <ProductDetailClient
                ...
                mainImage="/images/products/Vehicle-Disinfector/main/thumbnail.jpg"
                galleryImagesData={[]}
                videoGalleryData={[]}
                features={[
                    {
    ...
    return (
        <ProductDetailClient
            ...
            mainImage={product.image || "/images/products/Vehicle-Disinfector/main/thumbnail.jpg"}
