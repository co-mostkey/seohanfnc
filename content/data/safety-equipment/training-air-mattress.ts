...
const trainingAirMattress: SafetyEquipment = {
  ...
  // 제품 이미지 경로
  thumbnail: '/images/products/safety-equipment/training-air-mattress/thumbnail.jpg',
  images: [
    '/images/products/safety-equipment/training-air-mattress/image1.jpg',
    '/images/products/safety-equipment/training-air-mattress/image2.jpg',
    '/images/products/safety-equipment/training-air-mattress/image3.jpg',
  ],
  
  // 3D 모델 정보
  modelPath: '/models/safety-equipment/training-air-mattress.glb',
  ...
  documents: [
    ...
    },
    {
      ...
      type: 'guide',
      filePath: '/documents/safety-equipment/training-air-mattress-maintenance.pdf'
    },
    {
      ...
      type: 'datasheet',
      filePath: '/documents/safety-equipment/training-air-mattress-datasheet.pdf'
    }
  ],
